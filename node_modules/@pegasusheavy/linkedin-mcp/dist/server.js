...
export class LinkedInMCPServer {
    ...
    setupTools() {
        ...
        this.server.tool('get_linkedin_profile', 'Get the authenticated user\'s LinkedIn profile information', {}, async () => {
        ...
        this.server.tool('get_linkedin_posts', 'Get the user\'s recent LinkedIn posts', {
        ...
        this.server.tool('get_linkedin_connections', 'Get the user\'s LinkedIn connections', {
        ...
        this.server.tool('share_linkedin_post', 'Share a new post on LinkedIn', {
        ...
        this.server.tool('search_linkedin_people', 'Search for people on LinkedIn', {
        ...
        this.server.tool('add_linkedin_skill', 'Add a skill to your LinkedIn profile', {
        ...
        this.server.tool('delete_linkedin_skill', 'Delete a skill from your LinkedIn profile', {
        ...
        this.server.tool('add_linkedin_position', 'Add a work position to your LinkedIn profile', {
            ...
            try {
                ...
                const startDate = { year: startYear };
                if (startMonth !== undefined)
                    startDate.month = startMonth;
                const endDate = endYear ? { year: endYear } : undefined;
                if (endDate && endMonth !== undefined)
        ...
        this.server.tool('update_linkedin_position', 'Update an existing position on your LinkedIn profile', {
            ...
            try {
                ...
                if (startYear)
                    updates.startDate = { year: startYear, month: startMonth };
                if (endYear)
                    updates.endDate = { year: endYear, month: endMonth };
        ...
        this.server.tool('delete_linkedin_position', 'Delete a position from your LinkedIn profile', {
        ...
        this.server.tool('add_linkedin_education', 'Add education to your LinkedIn profile', {
            ...
            try {
                ...
                const startDate = startYear ? { year: startYear } : undefined;
                if (startDate && startMonth !== undefined)
                    startDate.month = startMonth;
                const endDate = endYear ? { year: endYear } : undefined;
                if (endDate && endMonth !== undefined)
                    endDate.month = endMonth;
        ...
        this.server.tool('delete_linkedin_education', 'Delete education from your LinkedIn profile', {
        ...
        this.server.tool('add_linkedin_certification', 'Add a certification to your LinkedIn profile', {
        ...
        this.server.tool('delete_linkedin_certification', 'Delete a certification from your LinkedIn profile', {
        ...
        this.server.tool('add_linkedin_publication', 'Add a publication to your LinkedIn profile', {
        ...
        this.server.tool('delete_linkedin_publication', 'Delete a publication from your LinkedIn profile', {
        ...
        this.server.tool('add_linkedin_language', 'Add a language to your LinkedIn profile', {
        ...
        this.server.tool('delete_linkedin_language', 'Delete a language from your LinkedIn profile', {
