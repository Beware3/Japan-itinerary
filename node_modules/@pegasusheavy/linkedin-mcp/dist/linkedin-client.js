...
import { LinkedInProfileSchema, LinkedInPostSchema, LinkedInConnectionSchema, } from './types.js';
...
export class LinkedInClient {
    ...
    logger;
    tokenProvider;
    constructor(tokenProvider, logger = new Logger()) {
        this.logger = logger;
    ...
    async searchPeople(keywords, limit = 10) {
        try {
            ...
            const people = response.data.elements?.map((person) => {
                return LinkedInConnectionSchema.parse({
                    id: person.id || '',
